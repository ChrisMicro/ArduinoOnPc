...
void setup()
{
  ...
  testFastLines(LTDC_RED, LTDC_BLUE);
  delay(500);


  testRects(LTDC_GREEN);
  delay(500);


  testFilledRects(LTDC_YELLOW, LTDC_MAGENTA);
  delay(500);


  testFilledCircles(10, LTDC_MAGENTA);


  testCircles(10, LTDC_WHITE);
  delay(500);
